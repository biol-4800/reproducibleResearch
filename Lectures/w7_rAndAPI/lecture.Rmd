...
This output is a list of length 4, each containing a nested list. It's not the cleanest output, but it rarely is. But all the information you could want is buried somewhere here. 
...
For this, we will have to include a dependency, which of course has a bunch of other dependencies. This is not really ideal given the focus on reproducible research in the course, but it is sadly pretty much necessary. 
...
survPlot <- left_join(surveys, plots, by='plot_id')
