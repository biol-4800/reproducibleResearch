...
plyr::adply(.data=my.array, .margins=1, .fun=sum) 
plyr::adply(.data=my.array, .margins=2, .fun=sum) 
plyr::adply(.data=my.array, .margins=3, .fun=sum) 
...
plyr::alply(.data=my.array, .margins=1, .fun=sum) 
